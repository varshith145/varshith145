...
Also built a local-first KG-RAG system with Neo4j and Ollama that shows exactly which sources a model grounded its answer on.<br>
Looking for roles in ML engineering, applied NLP, AI/LLM infrastructure and full-stack roles
